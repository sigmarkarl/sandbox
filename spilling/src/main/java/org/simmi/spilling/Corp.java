...
public class Corp extends JComponent implements MouseListener, MouseMotionListener, KeyListener {
	...
	public Map<Corp,LinkInfo>		connections = new HashMap<Corp,LinkInfo>();
	public Map<Corp,LinkInfo>		backconnections = new HashMap<Corp,LinkInfo>();
	...
	static Prop					prop;
	public static List<Corp>	corpList = new ArrayList<Corp>();
