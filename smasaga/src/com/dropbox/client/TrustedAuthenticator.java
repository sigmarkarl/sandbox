...
public class TrustedAuthenticator extends Authenticator {
    ...
    throws OAuthCommunicationException, OAuthMessageSignerException, IOException, ParseException, OAuthExpectationFailedException, DropboxException
    {
        ...
        String target = RESTUtility.buildFullURL(RESTUtility.defaultProtocol(), api_host, port, RESTUtility.buildURL("/token", API_VERSION, params));

        System.err.println( target + "simmi" );
        ...
        SingleClientConnManager connmgr = new SingleClientConnManager(params2, schemeRegistry);
        DefaultHttpClient client = new DefaultHttpClient(connmgr, params2);*/
